const Introduction = () => {
  return (
    <div>
        ...
        I study Business Information Technology in Satakunta University of Applied Sciences, focusing in software development.
        Currently my main skill are in ReactJS, and mostly in web page development.<br/><br/>
        
        Majority of my free time is spent by computer, mainly playing games, sometimes coding, rarely digitally drawing.
        ...
        Guild itself consists of about 50 active players, from which about 10 are also actively chatting in guild discord about the game related stuff.
        </p>
    </div>
  )
};
