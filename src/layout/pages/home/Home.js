const Home = () => {
    return (
        <div className=" h-auto ">
            ...
            <p className=" text-center">
                Made tool for quick searching basic Pokémon info using <u><a href="https://pokeapi.co/" target="_blank" rel="noopener noreferrer">PokeAPI</a></u>.<br/>
                Mainly tooled for phone usage while playing Pokémon myself, but have gotten very good feedback from friends trying it out as well.<br/>
                Find it&nbsp;<u><a href="https://hex-the-cat.github.io/pokemon/" target="_blank" rel="noopener noreferrer">here</a></u>.
                <br/><br/>
            </p>
            <p className=" text-center">
                ...
                <br/><br/>
                Plans for rewriting the webpage into more presentable condition.. underway..
            </p>
        </div>
    );
}
